...
const uiPlans: UiPlan[] = [
  {
    code: 'basic',
    name: 'Basic',
    desc: 'For casual readers who want access to a core library.',
    free: true,
    monthlyPrice: null,
    annualPrice: null,
    cta: 'Get started free',
    features: [
      { label: 'Up to 3 books / month', available: true },
      { label: 'Standard eBook formats (PDF, ePub)', available: true },
      { label: 'Web reader access', available: true },
      { label: 'Offline & mobile downloads', available: false },
      { label: 'Audiobook access', available: false },
      { label: 'Early access & new releases', available: false },
      { label: 'Highlights & annotations sync', available: false },
      { label: 'Priority support', available: false },
      { label: 'Family sharing (up to 5)', available: false },
      { label: 'Unlimited borrowing history', available: false },
    ],
  },
  {
    code: 'premium',
    name: 'Premium',
    desc: 'Most popular for avid readers who want the full library experience.',
    free: false,
    featured: true,
    monthlyPrice: 9.99,
    annualPrice: 7.49,
    cta: 'Start Premium',
    features: [
      { label: 'Unlimited books / month', available: true },
      { label: 'Standard eBook formats (PDF, ePub)', available: true },
      { label: 'Web reader access', available: true },
      { label: 'Offline & mobile downloads', available: true },
      { label: 'Audiobook access', available: true },
      { label: 'Early access & new releases', available: true },
      { label: 'Highlights & annotations sync', available: true },
      { label: 'Priority support', available: false },
      { label: 'Family sharing (up to 5)', available: false },
      { label: 'Unlimited borrowing history', available: false },
    ],
  },
  {
    code: 'family',
    name: 'Family & Pro',
    desc: 'For power users and families who want everything, shared.',
    free: false,
    monthlyPrice: 18.99,
    annualPrice: 14.24,
    cta: 'Choose Family & Pro',
    features: [
      { label: 'Unlimited books / month', available: true },
      { label: 'Standard eBook formats (PDF, ePub)', available: true },
      { label: 'Web reader access', available: true },
      ...
      { label: 'Family sharing (up to 5)', available: true },
      { label: 'Unlimited borrowing history', available: true },
    ],
  },
]
